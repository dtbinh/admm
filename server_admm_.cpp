...
{
  adresses[0] = "172.16.0.6";
  adresses[1] = "172.16.0.2";
  adresses[2] = "172.16.0.14";
  adresses[3] = "172.16.0.10";
}
...
int main ()
{
  ...
  unsigned char* point;
  uint64_t temp_64;
  x_and_u msg_recv, avg;
  admm_z msg_send;
  int i, j, len_recv = 16, len_send = 8, no_of_sockets = 4, iterations = 15;
  vector<int> sockets(no_of_sockets,0);
  vector<const char*> address(no_of_sockets,"172.16.0.14");
  ...
  for (j = 0; j < iterations; j++)
  {
    ...
    avg.x = avg.x/no_of_sockets;
    avg.u = avg.u/no_of_sockets;
