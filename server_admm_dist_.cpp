...
{
  adresses[0] = "172.16.0.2";
  adresses[1] = "172.16.0.10";
  adresses[2] = "172.16.0.29";
}
...
int main ()
{
  ...
  double v = 14.0, rho = 0.5;
  int i, j, len_recv = 16, len_send = 8, no_of_sockets = 4, iterations = 15, no_of_neigh = 3, no_of_bridges = 1;
  ...
  for (j = 0; j < iterations; j++)
  {
    ...
    msg_send_serv.x = (2*v + rho*sum_z_b - rho*msg_send_serv.u*no_of_bridges)/(2+rho*no_of_bridges);
    for (i = 0; i < no_of_bridges - 1; i++)
    {
